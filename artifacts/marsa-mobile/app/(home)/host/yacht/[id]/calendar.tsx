...
const styles = StyleSheet.create({
  ...
  headerCopy: { flex: 1 },
  headerTitle: { fontFamily: "Marcellus_400Regular", fontSize: 19 },
  headerSubtitle: {
  ...
  retryText: { fontFamily: "HankenGrotesk_700Bold", fontSize: 14 },
  monthBar: {
    flexDirection: "row",
    alignItems: "center",
  ...
  monthTitle: { fontFamily: "Marcellus_400Regular", fontSize: 18 },
  calendar: {
    marginHorizontal: 12,
    borderWidth: 1,
    borderRadius: 18,
  ...
  dayNumber: { fontFamily: "HankenGrotesk_600SemiBold", fontSize: 13 },
  ...
  legendText: { fontFamily: "HankenGrotesk_400Regular", fontSize: 10 },
  ...
  dayTitle: { fontFamily: "Marcellus_400Regular", fontSize: 17 },
  daySubtitle: { fontFamily: "HankenGrotesk_400Regular", fontSize: 12, marginTop: 3 },
  addButton: {
    minHeight: 40,
    borderRadius: 12,
  ...
  emptyTitle: { fontFamily: "HankenGrotesk_700Bold", fontSize: 15, marginTop: 8 },
  emptyCopy: {
    fontFamily: "HankenGrotesk_400Regular",
    fontSize: 12,
    lineHeight: 18,
  ...
  slotCopy: { flex: 1 },
  slotTime: { fontFamily: "HankenGrotesk_700Bold", fontSize: 14 },
  slotMeta: { fontFamily: "HankenGrotesk_400Regular", fontSize: 11, marginTop: 2 },
  slotRight: { alignItems: "flex-end" },
  slotPrice: { fontFamily: "HankenGrotesk_700Bold", fontSize: 12 },
  slotStatus: {
  ...
  editorTitle: { fontFamily: "Marcellus_400Regular", fontSize: 21 },
  editorDate: { fontFamily: "HankenGrotesk_400Regular", fontSize: 12, marginTop: 3 },
  inputLabel: {
    fontFamily: "HankenGrotesk_600SemiBold",
    fontSize: 13,
    marginBottom: 8,
  ...
  templateName: { fontFamily: "HankenGrotesk_700Bold", fontSize: 13 },
  templateDuration: {
    fontFamily: "HankenGrotesk_400Regular",
    fontSize: 10,
    marginTop: 2,
  ...
  currency: { fontFamily: "HankenGrotesk_700Bold", fontSize: 10 },
  priceTextInput: { flex: 1, fontFamily: "HankenGrotesk_600SemiBold", fontSize: 14 },
  inputHint: {
    fontFamily: "HankenGrotesk_400Regular",
    fontSize: 11,
    lineHeight: 16,
  ...
  toggleTitle: { fontFamily: "HankenGrotesk_700Bold", fontSize: 14 },
  toggleCopy: { fontFamily: "HankenGrotesk_400Regular", fontSize: 11, marginTop: 2 },
  errorBanner: {
    flexDirection: "row",
    alignItems: "flex-start",
    gap: 8,
  ...
  deleteConfirmationTitle: { fontFamily: "HankenGrotesk_700Bold", fontSize: 14 },
  ...
  keepButtonText: { fontFamily: "HankenGrotesk_700Bold", fontSize: 13 },
  confirmDeleteButton: {
    flex: 1,
    minHeight: 49,
    borderRadius: 14,
  ...
  deleteText: { fontFamily: "HankenGrotesk_700Bold", fontSize: 13 },
  saveButton: {
    flex: 1,
    minHeight: 49,
    borderRadius: 14,
  ...
  saveText: { color: "#FFFFFF", fontFamily: "HankenGrotesk_700Bold", fontSize: 14 },
});
