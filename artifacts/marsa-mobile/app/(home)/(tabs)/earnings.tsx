...
const styles = StyleSheet.create({
  ...
  ledgerType: { fontSize: 14, fontFamily: "Inter_600SemiBold" },
  ledgerDate: { fontSize: 12, fontFamily: "Inter_400Regular" },
  ledgerAmount: { fontSize: 14, fontFamily: "Inter_700Bold" },
  statusBadge: { fontSize: 12, fontFamily: "Inter_600SemiBold", textTransform: "capitalize" },
  ...
  availableLabel: { fontSize: 13, fontFamily: "Inter_500Medium" },
  availableAmount: { fontSize: 24, fontFamily: "Inter_700Bold" },
  field: { gap: 8 },
